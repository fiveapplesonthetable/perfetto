...
perfetto_filegroup(
    ...
    srcs = [
        ...
        "src/trace_processor/importers/proto/art_method_trace_module.cc",
        "src/trace_processor/importers/proto/art_method_trace_module.h",
...
perfetto_proto_library(
    ...
    srcs = [
        ...
        "protos/perfetto/config/android/art_method_trace_config.proto",
...
perfetto_proto_library(
    ...
    srcs = [
        ...
        "protos/perfetto/trace/android/art_method_trace.proto",
