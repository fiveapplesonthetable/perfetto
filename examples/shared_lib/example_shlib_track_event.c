...
int main(void) {
  ...
  for (;;) {
    ...
    // "CPU" (rank 2) regardless of when they first appear. The two events are
    // correlated: they are part of the same logical frame.
    ...
    PERFETTO_TE(
        ...
        PERFETTO_TE_NESTED_TRACKS(
            ...
            PERFETTO_TE_NESTED_TRACK_NAMED_MERGED(
                ...
                "worker_pool", 0)),
        PERFETTO_TE_CORRELATION_ID_STR("frame_pool"));
    sleep(1);
  }
}
