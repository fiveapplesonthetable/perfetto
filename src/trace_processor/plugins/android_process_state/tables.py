    ...
    tabledoc=TableDoc(
        ...
        columns={
            ...
            'oom_score': 'oom_adj score after the change (lower = more '
                         'important).',
            'capability_flags': 'Granted capabilities after the change; bitmask '
                                'of ProcessCapabilityEnum.',
            'reason': 'OomChangeReasonEnum name of the oom-adj pass that caused '
                      'the change; NULL for an initial-state row.',
            'seq_id': 'oom-adj pass sequence id the change belongs to; NULL for '
