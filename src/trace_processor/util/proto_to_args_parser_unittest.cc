...
TEST_F(ProtoToArgsParserTest, FlagsFieldExpandsToArgs) {
  ...
  // Build a descriptor set with an enum whose values are the flag bits, a
  // FieldOptions carrying the (flags_enum) option, and a message with an int32
  // field annotated with it.
