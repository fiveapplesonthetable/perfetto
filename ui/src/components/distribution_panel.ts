...
export const FLAMEGRAPH_HELP =
  ...
  'you can see where the time inside them goes. Brush a range (bucket) on the ' +
  'histogram to build it; up to a few hundred of the longest instances in the ' +
  'range are used, so it stays fast even for very common slice names.';
          ...
          : brush === undefined
            ? m(
                ...
                'Brush a duration range on the histogram to build a slice ' +
                  ...
                  'slices to show where the time inside them goes.',
              )
            : m(SliceFlamegraph, {
                trace: attrs.trace,
