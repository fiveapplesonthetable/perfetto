...
import {buildProcessState} from './dumpsys_source';
...
export default class implements PerfettoPlugin {
  ...
  async onTraceLoad(ctx: Trace): Promise<void> {
    // Build the _ps_* relations the explorer reads, either from a dumpsys
    // activity --proto capture (ExtensionDescriptor args) or, for legacy
    // traces, from the android.process_state tables. Zero rows → no data.
