...
// ProcessStateController snapshots. Every process with its resolved oom-adj
// "why" (adj_type/source), its service & content-provider bindings, and
// lifecycle events — answering "why is this process alive / at this adj?".
