...
import {KEY_COL, STATUS_COL, baselineCol, currentCol, deltaCol} from './diff_rows';
 ...
 */
export const statusRenderer: CellRenderer = (value: SqlValue): CellRenderResult => {
...
function renderDelta(
  ...
  const n = toNum(value);
  if (n == null) {
    return {content: m('span', {class: 'ah-mono ah-muted'}, '—'), align: 'right'};
  }
 ...
 */
export const sideSizeRenderer: CellRenderer = (value: SqlValue): CellRenderResult => {
  const n = toNum(value);
  if (n == null) {
    return {content: m('span', {class: 'ah-mono ah-muted'}, '—'), align: 'right'};
  }
...
/** Per-side count. */
export const sideCountRenderer: CellRenderer = (value: SqlValue): CellRenderResult => {
  const n = toNum(value);
  if (n == null) {
    return {content: m('span', {class: 'ah-mono ah-muted'}, '—'), align: 'right'};
  }
