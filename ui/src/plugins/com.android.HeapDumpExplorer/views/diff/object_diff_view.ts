...
const FIELD_DIFF_SCHEMA: ColumnSchema = {
...
const ARRAY_DIFF_SCHEMA: ColumnSchema = {
...
const SIZE_OR_COUNT_SCHEMA: ColumnSchema = (() => {
...
function buildInstanceDiffSchema(navigate: NavFn): ColumnSchema {
